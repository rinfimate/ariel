...
if (!fs.existsSync(src)) {
  console.log('[ariel] copy-wasm-to-lib: src/generated/web/wasm-bindgen not found — skipping (run yarn ubrn:web first)');
  process.exit(0);
}
...
console.log(`[ariel] Copied ${copied} wasm-bindgen files → lib/module/generated/web/wasm-bindgen/`);
